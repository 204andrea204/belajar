    ...
    <div class="col md-8">
          ...
          <?php
            ...
            <tr>
              ...
              <td>{!!$q->rincian!!}</td>
              <td>
                <a href="{{url('admin/pemasukan/edit/'.$q->id)}}" class="btn btn-outline-warning btn-sm"><i class="fas fa-edit"></i>                
                </a>
                 <a href="{{url('admin/pemasukan/delete/'.$q->id)}}" onclick="return confirm('anda yakin untuk menghapusnya ?')" 
        ...
        <div class="row">
          <a href="{{url('/admin/pemasukan/add')}}" class="btn btn-outline-primary btn-lg"><i class="fas fa-plus-square"></i></a>
